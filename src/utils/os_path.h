 ...
 *
 * The dague_os_path() function takes a variable number of string arguments and
...
*/
DAGUE_DECLSPEC char *dague_os_path(bool relative, ...);
...
static inline char* dague_make_filename_os_friendly( char* filename )
{
    char* p = filename;
    size_t length;
...
#else
#define dague_make_filename_os_friendly(PATH)   (PATH)
#endif  /* defined(__WINDOWS__) */

END_C_DECLS

#endif /* DAGUE_OS_PATH_H */
