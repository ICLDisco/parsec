...
BEGIN_C_DECLS
   ...
   */
DAGUE_DECLSPEC  int dague_argv_append(int *argc, char ***argv, const char *arg);
   ...
   * @retval OPAL_ERROR On failure
   *
   * This function is identical to the dague_argv_append() function
   ...
   */
DAGUE_DECLSPEC  int dague_argv_append_nosize(char ***argv, const char *arg);
 ...
 * @retval OPAL_ERROR On failure
 */
DAGUE_DECLSPEC int dague_argv_prepend_nosize(char ***argv, const char *arg);
 ...
 * @retval OPAL_ERROR On failure
 *
 * This function is identical to the dague_argv_append_nosize() function
 ...
 */
DAGUE_DECLSPEC  int dague_argv_append_unique_nosize(char ***argv, const char *arg, bool overwrite);
...
/**
   ...
   * array.
   */
DAGUE_DECLSPEC  void dague_argv_free(char **argv);
   ...
   */
DAGUE_DECLSPEC  char **dague_argv_split(const char *src_string, int delimiter);
   ...
   * without invalidating the output argv).
   */
DAGUE_DECLSPEC  char **dague_argv_split_with_empty(const char *src_string, int delimiter);
   ...
   */
DAGUE_DECLSPEC  int dague_argv_count(char **argv);
   ...
   */
DAGUE_DECLSPEC  char *dague_argv_join(char **argv, int delimiter);

DAGUE_DECLSPEC  char *dague_argv_join_range(char **argv, size_t start, size_t end, int delimiter);
   ...
   */
DAGUE_DECLSPEC  size_t dague_argv_len(char **argv);
   ...
   */
DAGUE_DECLSPEC  char **dague_argv_copy(char **argv);
     ...
     */
DAGUE_DECLSPEC  int dague_argv_delete(int *argc, char ***argv, 
     ...
     * target).
     */
DAGUE_DECLSPEC  int dague_argv_insert(char ***target, int start, char **source);
 ...
 * target).
 */
DAGUE_DECLSPEC  int dague_argv_insert_element(char ***target, int location, char *source);
