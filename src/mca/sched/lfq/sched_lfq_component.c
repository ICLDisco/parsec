 ...
 */
const dague_sched_base_component_t dague_sched_lfq_component = {
...
{
    return (mca_base_component_t *)&dague_sched_lfq_component;
}

static int sched_lfq_component_query(mca_base_module_t **module, int *priority)
{
    *priority = 20;
    *module = (mca_base_module_t *)&dague_sched_lfq_module;
    return MCA_SUCCESS;
}
