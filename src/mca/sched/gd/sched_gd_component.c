 ...
 */
const dague_sched_base_component_t dague_sched_gd_component = {
...

    {
        ...
        NULL, /*< No register: no parameters to the global dequeue component */
        "", /*< no reserve */
    },
    {
...
{
    return (mca_base_component_t *)&dague_sched_gd_component;
}
