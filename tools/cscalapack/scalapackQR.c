...
extern void pdgeqrf_( int* m, int *n, double *a, int *i1, int *i2, int *desca, int* ipiv, int *info );
...
/**/
	...
	{ int i1=1; pdgeqrf_( &n, &n, A, &i1, &i1, descA, ippiv, &my_info_facto ); }
	my_elapsed += MPI_Wtime();
