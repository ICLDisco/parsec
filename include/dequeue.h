...
{
    return dague_list_push_back((dague_list_t*)dequeue, item);
}

static inline void 
dague_dequeue_push_front( dague_dequeue_t* dequeue, dague_list_item_t* item )
{
    return dague_list_push_front((dague_list_t*)dequeue, item);
}

static inline void
dague_dequeue_chain_front( dague_dequeue_t* dequeue, dague_list_item_t* items )
{
    return dague_list_chain_front((dague_list_t*)dequeue, items);
}

static inline void
dague_dequeue_chain_back( dague_dequeue_t* dequeue, dague_list_item_t* items )
{
    return dague_list_chain_back((dague_list_t*)dequeue, items);
}
...
{
    return dague_list_nolock_push_front((dague_list_t*)dequeue, item);
}
...
{
    return dague_list_nolock_push_back((dague_list_t*)dequeue, item);
}
...
{
    return dague_list_nolock_chain_front((dague_list_t*)dequeue, items);
}
...
{
    return dague_list_nolock_chain_back((dague_list_t*)dequeue, items);
}
