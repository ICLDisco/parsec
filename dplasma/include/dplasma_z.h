 ...
 */
/* Level 2 Blas */
parsec_taskpool_t* dplasma_zgeadd_New( PLASMA_enum trans, parsec_complex64_t alpha, const tiled_matrix_desc_t *A, parsec_complex64_t beta, tiled_matrix_desc_t *B);
parsec_taskpool_t* dplasma_zgerc_New ( parsec_complex64_t alpha, const tiled_matrix_desc_t *X, const tiled_matrix_desc_t *Y, tiled_matrix_desc_t *A);
parsec_taskpool_t* dplasma_zgeru_New ( parsec_complex64_t alpha, const tiled_matrix_desc_t *X, const tiled_matrix_desc_t *Y, tiled_matrix_desc_t *A);
parsec_taskpool_t* dplasma_ztradd_New( PLASMA_enum uplo, PLASMA_enum trans, parsec_complex64_t alpha, const tiled_matrix_desc_t *A, parsec_complex64_t beta, tiled_matrix_desc_t *B);
...
/* Level 3 Blas extensions */
parsec_taskpool_t* dplasma_ztrsmpl_New(const tiled_matrix_desc_t *A, const tiled_matrix_desc_t *L,
                                    const tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *B);

/* Lapack */
parsec_taskpool_t* dplasma_zgebrd_ge2gb_New( int ib, tiled_matrix_desc_t *A, tiled_matrix_desc_t *Band );
parsec_taskpool_t* dplasma_zgebrd_ge2gbx_New( int ib, dplasma_qrtree_t *qrtre0, dplasma_qrtree_t *qrtree, dplasma_qrtree_t *lqtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS0, tiled_matrix_desc_t *TT0, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *Band );
parsec_taskpool_t* dplasma_zgelqf_New(tiled_matrix_desc_t *A, tiled_matrix_desc_t *T);
parsec_taskpool_t* dplasma_zgelqf_param_New(dplasma_qrtree_t *qrtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT);
parsec_taskpool_t* dplasma_zgeqrf_New(tiled_matrix_desc_t *A, tiled_matrix_desc_t *T);
parsec_taskpool_t* dplasma_zgeqrf_param_New(dplasma_qrtree_t *qrtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT);
parsec_taskpool_t* dplasma_zgetrf_New(tiled_matrix_desc_t *A, tiled_matrix_desc_t *IPIV, int *INFO);
parsec_taskpool_t* dplasma_zgetrf_incpiv_New(tiled_matrix_desc_t *A, tiled_matrix_desc_t *L, tiled_matrix_desc_t *IPIV, int *INFO);
parsec_taskpool_t* dplasma_zgetrf_nopiv_New(tiled_matrix_desc_t *A, int *INFO);
parsec_taskpool_t* dplasma_zlauum_New( PLASMA_enum uplo, tiled_matrix_desc_t *A);
parsec_taskpool_t* dplasma_zpoinv_New( PLASMA_enum uplo, tiled_matrix_desc_t *A, int *INFO);
parsec_taskpool_t* dplasma_zpotrf_New( PLASMA_enum uplo, tiled_matrix_desc_t *A, int *INFO);
parsec_taskpool_t* dplasma_ztrtri_New( PLASMA_enum uplo, PLASMA_enum diag, tiled_matrix_desc_t *A, int *info);
parsec_taskpool_t* dplasma_zunglq_New( tiled_matrix_desc_t *A, tiled_matrix_desc_t *T, tiled_matrix_desc_t *Q);
parsec_taskpool_t* dplasma_zunglq_param_New(dplasma_qrtree_t *qrtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *Q);
parsec_taskpool_t* dplasma_zungqr_New( tiled_matrix_desc_t *A, tiled_matrix_desc_t *T, tiled_matrix_desc_t *Q);
parsec_taskpool_t* dplasma_zungqr_param_New(dplasma_qrtree_t *qrtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *Q);
parsec_taskpool_t* dplasma_zunmlq_New( PLASMA_enum side, PLASMA_enum trans, tiled_matrix_desc_t *A, tiled_matrix_desc_t *T, tiled_matrix_desc_t *B);
parsec_taskpool_t* dplasma_zunmlq_param_New( PLASMA_enum side, PLASMA_enum trans, dplasma_qrtree_t *qrtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *B);
parsec_taskpool_t* dplasma_zunmqr_New( PLASMA_enum side, PLASMA_enum trans, tiled_matrix_desc_t *A, tiled_matrix_desc_t *T, tiled_matrix_desc_t *B);
parsec_taskpool_t* dplasma_zunmqr_param_New( PLASMA_enum side, PLASMA_enum trans, dplasma_qrtree_t *qrtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *B);

/* Auxiliary routines */
parsec_taskpool_t* dplasma_zlacpy_New( PLASMA_enum uplo, const tiled_matrix_desc_t *A, tiled_matrix_desc_t *B);
parsec_taskpool_t* dplasma_zlange_New( PLASMA_enum ntype, const tiled_matrix_desc_t *A, double *norm);
parsec_taskpool_t* dplasma_zlanhe_New( PLASMA_enum ntype, PLASMA_enum uplo, const tiled_matrix_desc_t *A, double *result);
parsec_taskpool_t* dplasma_zlanm2_New( const tiled_matrix_desc_t *A, double *norm, int *info );
parsec_taskpool_t* dplasma_zlansy_New( PLASMA_enum ntype, PLASMA_enum uplo, const tiled_matrix_desc_t *A, double *result);
parsec_taskpool_t* dplasma_zlantr_New( PLASMA_enum ntype, PLASMA_enum uplo, PLASMA_enum diag, const tiled_matrix_desc_t *A, double *result);
parsec_taskpool_t* dplasma_zlascal_New( PLASMA_enum type, parsec_complex64_t alpha, tiled_matrix_desc_t *A);
parsec_taskpool_t* dplasma_zlaset_New( PLASMA_enum uplo, parsec_complex64_t alpha, parsec_complex64_t beta, tiled_matrix_desc_t *A);
parsec_taskpool_t* dplasma_zlaswp_New( tiled_matrix_desc_t *A, const tiled_matrix_desc_t *IPIV, int inc);
parsec_taskpool_t* dplasma_zplghe_New( double            bump, PLASMA_enum uplo, tiled_matrix_desc_t *A, unsigned long long int seed);
parsec_taskpool_t* dplasma_zplgsy_New( parsec_complex64_t bump, PLASMA_enum uplo, tiled_matrix_desc_t *A, unsigned long long int seed);
parsec_taskpool_t* dplasma_zplrnt_New( int diagdom,                              tiled_matrix_desc_t *A, unsigned long long int seed);

/* Sub-kernels to recursive DAGs */
parsec_taskpool_t* dplasma_zgeqrfr_geqrt_New(tiled_matrix_desc_t *A,  tiled_matrix_desc_t *T,  void *work);
parsec_taskpool_t* dplasma_zgeqrfr_tsmqr_New(tiled_matrix_desc_t *A1, tiled_matrix_desc_t *A2, tiled_matrix_desc_t *V, tiled_matrix_desc_t *T, void *work);
parsec_taskpool_t* dplasma_zgeqrfr_tsqrt_New(tiled_matrix_desc_t *A1, tiled_matrix_desc_t *A2, tiled_matrix_desc_t *T, void *tau, void *work);
parsec_taskpool_t* dplasma_zgeqrfr_unmqr_New(tiled_matrix_desc_t *A,  tiled_matrix_desc_t *T,  tiled_matrix_desc_t *B, void *work);
...
parsec_taskpool_t* dplasma_zgetrf_qrf_New( dplasma_qrtree_t *qrtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, int criteria, double alpha, int *lu_tab, int *INFO);
parsec_taskpool_t* dplasma_ztrsmpl_qrf_New(dplasma_qrtree_t *qrtree, tiled_matrix_desc_t *A, tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *B, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, int *lu_tab);
...
parsec_taskpool_t* dplasma_zgebmm_New( tiled_matrix_desc_t *A, parsec_complex64_t *U_but_vec, int it, int jt, int level, PLASMA_enum trans, int *info);
parsec_taskpool_t* dplasma_zgebut_New( tiled_matrix_desc_t *A, parsec_complex64_t *U_but_vec, int it, int jt, int level, int *info);
parsec_taskpool_t* dplasma_zhebut_New( tiled_matrix_desc_t *A, parsec_complex64_t *U_but_vec, int it, int jt, int level, int *info);
parsec_taskpool_t* dplasma_zhetrf_New( tiled_matrix_desc_t *A, int *info);
parsec_taskpool_t* dplasma_ztrdsm_New( const tiled_matrix_desc_t *A, tiled_matrix_desc_t *B );
parsec_taskpool_t* dplasma_ztrmdm_New( tiled_matrix_desc_t *A);
...
/* SVD */
parsec_taskpool_t* dplasma_zhbrdt_New(tiled_matrix_desc_t *A);
parsec_taskpool_t* dplasma_zheev_New( const PLASMA_enum jobz, const PLASMA_enum uplo, tiled_matrix_desc_t* A, tiled_matrix_desc_t* W, tiled_matrix_desc_t* Z, int* info );
parsec_taskpool_t* dplasma_zherbt_New( PLASMA_enum uplo, int ib, tiled_matrix_desc_t *A, tiled_matrix_desc_t *T);
