...
int dplasma_zgetrf_qrf( dague_context_t *dague, qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *SAV, tiled_matrix_desc_t *LT, int* lu_tab, int* INFO);
...
int dplasma_ztrsmpl_qrf( dague_context_t *dague, qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *B, tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *SAV, tiled_matrix_desc_t *LT, int* lu_tab, int* INFO);
...
dague_object_t* dplasma_zgetrf_qrf_New(qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *SAV, tiled_matrix_desc_t *LT, int* lu_tab, int* INFO);
...
dague_object_t* dplasma_ztrsmpl_qrf_New(qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *B, tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *SAV, tiled_matrix_desc_t *LT, int* lu_tab, int* INFO);
