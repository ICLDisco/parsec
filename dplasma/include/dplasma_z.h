...
void dplasma_ztrsmpl_param( dague_context_t *dague, qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *B, 
                           tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *LT, int* INFO);
...
int dplasma_zhetrs( dague_context_t *dague, const tiled_matrix_desc_t *A, tiled_matrix_desc_t *B);
...
int dplasma_zgetrf_param( dague_context_t *dague, qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *LT, int* INFO);
int dplasma_zgetrf_param2( dague_context_t *dague, qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *IPIV, int* INFO);
...
dague_object_t* dplasma_ztrsmpl_New(const tiled_matrix_desc_t *A, const tiled_matrix_desc_t *L,
                                    const tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *B);
dague_object_t* dplasma_ztrsmpl_param_New( qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *B, 
                                          tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *LT, int* INFO);
...
dague_object_t* dplasma_zgetrf_param_New(qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *IPIV, tiled_matrix_desc_t *LT, int* INFO);
dague_object_t* dplasma_zgetrf_param2_New(qr_piv_t *qrpiv, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *IPIV, int* INFO);
...
void dplasma_ztrsmpl_param_Destruct( dague_object_t *o );
...
void dplasma_zgetrf_param_Destruct( dague_object_t *o );
void dplasma_zgetrf_param2_Destruct( dague_object_t *o );
