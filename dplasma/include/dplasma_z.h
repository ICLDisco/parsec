...
void dplasma_zhemm( dague_context_t *dague, const PLASMA_enum side, const PLASMA_enum uplo,
                    const Dague_Complex64_t alpha, const tiled_matrix_desc_t* A, const tiled_matrix_desc_t* B,
...
int dplasma_zgeqrf_param( dague_context_t *dague, int tree_llvl, int tree_hlvl, int sze_ts, int sze_hlvl, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT);
...
int dplasma_zungqr_param( dague_context_t *dague, int tree_llvl, int tree_hlvl, int sze_ts, int sze_hlvl, 
                          tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *Q);

int dplasma_zaxpy(  dague_context_t *dague, PLASMA_enum uplo, Dague_Complex64_t alpha, tiled_matrix_desc_t *A, tiled_matrix_desc_t *B);
...
dague_object_t* dplasma_zgeqrf_param_New(int tree_llvl, int tree_hlvl, int sze_ts, int sze_hlvl, tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT);
...
dague_object_t* dplasma_zungqr_param_New(int tree_llvl, int tree_hlvl, int sze_ts, int sze_hlvl, 
                                         tiled_matrix_desc_t *A, tiled_matrix_desc_t *TS, tiled_matrix_desc_t *TT, tiled_matrix_desc_t *Q);
...
/* Auxiliary routines */
dague_object_t* dplasma_zaxpy_New(  PLASMA_enum uplo, Dague_Complex64_t alpha, tiled_matrix_desc_t *A, tiled_matrix_desc_t *B);
...
void dplasma_zaxpy_Destruct( dague_object_t *o );
