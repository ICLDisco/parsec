...
zgemm_kernel_T_N_32_32_8_8_8_ssrfb(
        ...
        const double *A1, int lda1) 
{
	...
	switch(lda){
		case 16:
			C[0]     = Cb[0] + A1[0];
			C[1*ldc] = Cb[1] + A1[1*ldc];
			C[2*ldc] = Cb[2] + A1[2*ldc];
			C[3*ldc] = Cb[3] + A1[3*ldc];
			C[4*ldc] = Cb[4] + A1[4*ldc];
			C[5*ldc] = Cb[5] + A1[5*ldc];
			C[6*ldc] = Cb[6] + A1[6*ldc];
			C[7*ldc] = Cb[7] + A1[7*ldc];
			C[8*ldc] = Cb[8] + A1[8*ldc];
			C[9*ldc] = Cb[9] + A1[9*ldc];
			C[10*ldc] = Cb[10] + A1[10*ldc];
			C[11*ldc] = Cb[11] + A1[11*ldc];
			C[12*ldc] = Cb[12] + A1[12*ldc];
			C[13*ldc] = Cb[13] + A1[13*ldc];
			C[14*ldc] = Cb[14] + A1[14*ldc];
			C[15*ldc] = Cb[15] + A1[15*ldc];
			break;
		case 15:
			C[0]     = Cb[0] + A1[0];
			C[1*ldc] = Cb[1] + A1[1*ldc];
...
extern "C" void
magmablas_zgemm_kernel_T_N_32_32_8_8_8_ssrfb( 
	int m, int n, int k,
	const double *A, int lda, 
	const double *B, int ldb, 
	double *C, int ldc, 
        const double *A1, int lda1, CUstream stream)
{	
        dim3 threads( 8, 8 );
        dim3 grid(m/32+(m%32!=0),n/32+(n%32!=0));
        zgemm_kernel_T_N_32_32_8_8_8_ssrfb<<< grid, threads, 0, stream>>>(C, A, B, 
