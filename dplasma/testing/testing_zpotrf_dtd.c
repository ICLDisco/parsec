...
int main(int argc, char **argv)
{
    ...
    for(k=0;k<total;k++){
        ...
        insert_task_in_PaRSEC(DAGUE_dtd_handle, &call_to_kernel_PO, "Potrf",
        ...
        for(m=k+1;m<total;m++){
            ...
            insert_task_in_PaRSEC(DAGUE_dtd_handle, &call_to_kernel_TR, "Trsm",
        ...
        for(m=k+1;m<total;m++){
            tempmm = m == ddescA.super.mt - 1 ? ddescA.super.m - m * ddescA.super.mb : ddescA.super.mb;
            ldam = BLKLDD(ddescA.super, m);
            insert_task_in_PaRSEC(DAGUE_dtd_handle, &call_to_kernel_HE, "Herk",
                                    sizeof(int),       &uplo,               VALUE,
            ...
            for(n=k+1;n<m;n++){
                   ...
                   insert_task_in_PaRSEC(DAGUE_dtd_handle,  &call_to_kernel_GE, "Gemm",
