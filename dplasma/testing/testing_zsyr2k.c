...
int main(int argc, char ** argv)
{
    ...
    if(!check)
    {
        ...
        dplasma_zplgsy( parsec, 0., uplo, (tiled_matrix_desc_t *)&ddescC, Cseed);
    ...
    else
    {
        ...
        for (u=0; u<2; u++) {
            ...
            for (t=0; t<2; t++) {
                ...
                dplasma_zplrnt( parsec, 0, (tiled_matrix_desc_t *)&ddescA, Aseed);
                dplasma_zplrnt( parsec, 0, (tiled_matrix_desc_t *)&ddescB, Bseed);
                dplasma_zplgsy( parsec, 0., uplo[u], (tiled_matrix_desc_t *)&ddescC, Cseed);
                if (loud > 2) printf("Done\n");
                           ...
                           sym_two_dim_block_cyclic_t *ddescCfinal )
{
    ...
    dplasma_zplrnt( parsec, 0, (tiled_matrix_desc_t *)&ddescA, Aseed);
    dplasma_zplrnt( parsec, 0, (tiled_matrix_desc_t *)&ddescB, Bseed);
    dplasma_zplgsy( parsec, 0., PlasmaUpperLower, (tiled_matrix_desc_t *)&ddescC, Cseed );
    ...
    Cdplasmanorm = dplasma_zlansy( parsec, PlasmaInfNorm, uplo, (tiled_matrix_desc_t*)ddescCfinal );
    ...
    Clapacknorm = dplasma_zlansy( parsec, PlasmaInfNorm, uplo, (tiled_matrix_desc_t*)&ddescC );

    dplasma_ztradd( parsec, uplo, PlasmaNoTrans,
                    -1.0, (tiled_matrix_desc_t*)ddescCfinal,
                     1.0, (tiled_matrix_desc_t*)&ddescC );

    Rnorm = dplasma_zlansy( parsec, PlasmaMaxNorm, uplo, (tiled_matrix_desc_t*)&ddescC );
