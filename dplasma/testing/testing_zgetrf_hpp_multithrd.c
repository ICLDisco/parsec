...
int main(int argc, char ** argv)
{
    ...
    PASTE_CODE_ENQUEUE_KERNEL(dague, zgetrf_hpp_multithrd,
                              (qrpiv,
                               (tiled_matrix_desc_t*)&ddescA,
                               ...
                               &info));
    /* lets rock! */
    PASTE_CODE_PROGRESS_KERNEL(dague, zgetrf_hpp_multithrd);
    dplasma_zgetrf_hpp_Destruct( DAGUE_zgetrf_hpp_multithrd );
    if(loud > 2) printf("Done.\n");
