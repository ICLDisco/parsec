...
foreach(prec ${DPLASMA_PRECISIONS} )
  ...
  add_test(shm_${prec}getrf_${DTD_TEST}        ${SHM_TEST_CMD_LIST} ./testing_${prec}getrf        -N 378 -t 93       ${OPTIONS} ${DTD_OPTIONS})
  ...
  add_test(shm_${prec}getrf_qrf_${DTD_TEST}    ${SHM_TEST_CMD_LIST} ./testing_${prec}getrf_qrf    -N 378 -t 93 -i 17 ${OPTIONS} ${DTD_OPTIONS})
