...
add_test(dsyrk ${SHM_TEST_CMD} ./testing_dsyrk -M 1067 -N 2873 -K 987 -t 56 -x -v=5)
add_test(csyrk ${SHM_TEST_CMD} ./testing_csyrk -M 1067 -N 2873 -K 987 -t 56 -x -v=5)
add_test(cherk ${SHM_TEST_CMD} ./testing_cherk -M 1067 -N 2873 -K 987 -t 56 -x -v=5)
...
if( MPI_FOUND )
  ...
  add_test(mpi_dsyrk         ${MPI_TEST_CMD} ./testing_dsyrk         -p 4 -M 1067 -N 2873 -K 987 -t 56 -x -v=5)
  add_test(mpi_csyrk         ${MPI_TEST_CMD} ./testing_csyrk         -p 4 -M 1067 -N 2873 -K 987 -t 56 -x -v=5)
  add_test(mpi_cherk         ${MPI_TEST_CMD} ./testing_cherk         -p 4 -M 1067 -N 2873 -K 987 -t 56 -x -v=5)
