...
if( MPI_C_FOUND )
  ...
  foreach(prec ${DPLASMA_PRECISIONS})
    ...
    # check the norms that are used in all other testings
    add_test(mpi_${prec}lange ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}lange -P 4 -M 287 -N 283 -K 97 -t 19 -x -v=5)
    set_tests_properties(mpi_${prec}lange PROPERTIES DEPENDS mpi_${prec}print)

    # Need to add testings on zlacpy, zlaset, zgeadd, zlascal, zger, (zlaswp?)

    # BLAS Shared memory
    add_test(mpi_${prec}trmm  ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}trmm  -P 4 -M 106 -N 150 -K 97 -t 19 -x -v=5)
    set_tests_properties(mpi_${prec}trmm PROPERTIES DEPENDS mpi_${prec}lange)

    add_test(mpi_${prec}trsm  ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}trsm  -P 4 -M 106 -N 150 -K 97 -t 19 -x -v=5)
    set_tests_properties(mpi_${prec}trsm PROPERTIES DEPENDS mpi_${prec}trmm)

    add_test(mpi_${prec}gemm  ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}gemm  -P 4 -M 106 -N 283 -K 97 -t 19 -x -v=5)
    set_tests_properties(mpi_${prec}trmm PROPERTIES DEPENDS mpi_${prec}lange)

    add_test(mpi_${prec}symm  ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}symm  -P 4 -M 106 -N 283 -K 97 -t 19 -x -v=5)
    set_tests_properties(mpi_${prec}trmm PROPERTIES DEPENDS mpi_${prec}lange)

    add_test(mpi_${prec}syrk  ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}syrk  -P 4 -M 287 -N 283 -K 97 -t 19 -x -v=5)
    add_test(mpi_${prec}syr2k ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}syr2k -P 4 -M 287 -N 283 -K 97 -t 19 -x -v=5)

    if ( "${prec}" STREQUAL "c" OR "${prec}" STREQUAL "z" )
      add_test(mpi_${prec}hemm  ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}hemm  -P 4 -M 106 -N 283 -K 97 -t 19 -x -v=5)
      add_test(mpi_${prec}herk  ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}herk  -P 4 -M 287 -N 283 -K 97 -t 19 -x -v=5)
      add_test(mpi_${prec}her2k ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}her2k -P 4 -M 287 -N 283 -K 97 -t 19 -x -v=5)
    endif()

    # Cholesky
    add_test(mpi_${prec}potrf ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}potrf -N 378 -t 19        -x -v=5)
    add_test(mpi_${prec}posv  ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}posv  -N 457 -t 19 -K 367 -x -v=5)

    # QR / LQ
    add_test(mpi_${prec}geqrf ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}geqrf -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
    add_test(mpi_${prec}gelqf ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}gelqf -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    if ( "${prec}" STREQUAL "c" OR "${prec}" STREQUAL "z" )
      add_test(mpi_${prec}unmqr ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}unmqr -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
      add_test(mpi_${prec}unmlq ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}unmlq -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    else()
      add_test(mpi_${prec}ormqr ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}ormqr -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
      add_test(mpi_${prec}ormlq ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}ormlq -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    endif()

    # QR / LQ: HQR
    add_test(mpi_${prec}geqrf_hqr ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}geqrf_hqr -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
    add_test(mpi_${prec}gelqf_hqr ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}gelqf_hqr -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    if ( "${prec}" STREQUAL "c" OR "${prec}" STREQUAL "z" )
      add_test(mpi_${prec}unmqr_hqr ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}unmqr_hqr -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
      add_test(mpi_${prec}unmlq_hqr ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}unmlq_hqr -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    else()
      add_test(mpi_${prec}ormqr_hqr ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}ormqr_hqr -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
      add_test(mpi_${prec}ormlq_hqr ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}ormlq_hqr -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    endif()

    # QR / LQ: systolic
    add_test(mpi_${prec}geqrf_systolic ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}geqrf_systolic -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
    add_test(mpi_${prec}gelqf_systolic ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}gelqf_systolic -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    if ( "${prec}" STREQUAL "c" OR "${prec}" STREQUAL "z" )
      add_test(mpi_${prec}unmqr_systolic ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}unmqr_systolic -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
      add_test(mpi_${prec}unmlq_systolic ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}unmlq_systolic -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    else()
      add_test(mpi_${prec}ormqr_systolic ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}ormqr_systolic -P 4 -M 487 -N 283 -K 97 -t 19 -x -v=5)
      add_test(mpi_${prec}ormlq_systolic ${MPI_TEST_CMD_LIST} -np ${NPROCS}  ./testing_${prec}ormlq_systolic -P 4 -M 287 -N 383 -K 97 -t 19 -x -v=5)
    endif()

    # LU
    add_test(mpi_${prec}getrf        ${MPI_TEST_CMD_LIST} -np ${NPROCS} ./testing_${prec}getrf        -P 1 -N 378 -t 19      -x -v=5)
    add_test(mpi_${prec}getrf_incpiv ${MPI_TEST_CMD_LIST} -np ${NPROCS} ./testing_${prec}getrf_incpiv -P 2 -N 378 -t 19 -i 7 -x -v=5)
    add_test(mpi_${prec}getrf_nopiv  ${MPI_TEST_CMD_LIST} -np ${NPROCS} ./testing_${prec}getrf_nopiv  -P 2 -N 378 -t 19      -x -v=5)
    add_test(mpi_${prec}getrf_qrf    ${MPI_TEST_CMD_LIST} -np ${NPROCS} ./testing_${prec}getrf_qrf    -P 2 -N 378 -t 19 -i 7 -x -v=5)

    #add_test(mpi_${prec}gesv         ${MPI_TEST_CMD_LIST} ./testing_${prec}gesv         -N 874 -K 367 -t 76       -x -v=5)
    add_test(mpi_${prec}gesv_incpiv  ${MPI_TEST_CMD_LIST} ./testing_${prec}gesv_incpiv  -N 874 -K 367 -t 17 -i 7 -x -v=5)
