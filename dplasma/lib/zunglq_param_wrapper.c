 ...
 *
 *  dplasma_zunglq_param_New - Generates the parsec taskpool that computes the generation
...
{
    parsec_zunglq_param_taskpool_t* tp;
    int ib = TS->mb;
 ...
 * @ingroup dplasma_complex64
 *
 *  dplasma_zunglq_param_Destruct - Free the data structure associated to an taskpool
 ...
 ******************************************************************************/
void
dplasma_zunglq_param_Destruct( parsec_taskpool_t *tp )
{
    parsec_zunglq_param_taskpool_t *parsec_zunglq = (parsec_zunglq_param_taskpool_t *)tp;
