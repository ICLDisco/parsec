...
dplasma_ztrsmpl_qrf_New( dplasma_qrtree_t *qrtree,
                         ...
                         int *lu_tab )
{
    parsec_ztrsmpl_qrf_handle_t* handle;
    int ib = TS->mb;
    ...
    handle = parsec_ztrsmpl_qrf_new(A,
                                   (parsec_ddesc_t*)IPIV,
                                   TS,
                                   TT,
                                   B,
    ...
    /* Default type */
    dplasma_add2arena_tile( handle->arenas[PARSEC_ztrsmpl_qrf_DEFAULT_ARENA],
                            A->mb*A->nb*sizeof(parsec_complex64_t),
                            PARSEC_ARENA_ALIGNMENT_SSE,
                            parsec_datatype_double_complex_t, A->mb );

    /* Upper triangular part of tile with diagonal */
    dplasma_add2arena_upper( handle->arenas[PARSEC_ztrsmpl_qrf_UPPER_TILE_ARENA],
                             A->mb*A->nb*sizeof(parsec_complex64_t),
                             PARSEC_ARENA_ALIGNMENT_SSE,
                             parsec_datatype_double_complex_t, A->mb, 1 );

    /* Lower triangular part of tile without diagonal */
    dplasma_add2arena_lower( handle->arenas[PARSEC_ztrsmpl_qrf_LOWER_TILE_ARENA],
                             A->mb*A->nb*sizeof(parsec_complex64_t),
                             PARSEC_ARENA_ALIGNMENT_SSE,
                             parsec_datatype_double_complex_t, A->mb, 0 );

    /* Little T */
    dplasma_add2arena_rectangle( handle->arenas[PARSEC_ztrsmpl_qrf_LITTLE_T_ARENA],
                                 TS->mb*TS->nb*sizeof(parsec_complex64_t),
                                 PARSEC_ARENA_ALIGNMENT_SSE,
                                 parsec_datatype_double_complex_t, TS->mb, TS->nb, -1);

    /* IPIV */
    dplasma_add2arena_rectangle( handle->arenas[PARSEC_ztrsmpl_qrf_PIVOT_ARENA],
                                 A->mb*sizeof(int),
                                 PARSEC_ARENA_ALIGNMENT_SSE,
...
void
dplasma_ztrsmpl_qrf_Destruct( parsec_handle_t *handle )
{
    parsec_ztrsmpl_qrf_handle_t *parsec_ztrsmpl_qrf = (parsec_ztrsmpl_qrf_handle_t *)handle;
...
dplasma_ztrsmpl_qrf( parsec_context_t *parsec,
                     ...
                     int *lu_tab)
{
    parsec_handle_t *parsec_ztrsmpl_qrf = NULL;

    parsec_ztrsmpl_qrf = dplasma_ztrsmpl_qrf_New(qrtree, A, IPIV, B, TS, TT, lu_tab);

    parsec_enqueue(parsec, (parsec_handle_t*)parsec_ztrsmpl_qrf);
