 ...
 *
 *  dplasma_zungqr_param_New - Generates the parsec handle that computes the generation
...
{
    parsec_zungqr_param_handle_t* handle;
    int ib = TS->mb;
    ...
    handle = parsec_zungqr_param_new( A,
                                     TS,
                                     TT,
                                     Q,
                                     *qrtree,
    ...
    /* Default type */
    dplasma_add2arena_tile( handle->arenas[PARSEC_zungqr_param_DEFAULT_ARENA],
                            A->mb*A->nb*sizeof(parsec_complex64_t),
                            PARSEC_ARENA_ALIGNMENT_SSE,
                            parsec_datatype_double_complex_t, A->mb );

    /* Upper triangular part of tile with diagonal */
    dplasma_add2arena_upper( handle->arenas[PARSEC_zungqr_param_UPPER_TILE_ARENA],
                             A->mb*A->nb*sizeof(parsec_complex64_t),
                             PARSEC_ARENA_ALIGNMENT_SSE,
                             parsec_datatype_double_complex_t, A->mb, 1 );

    /* Lower triangular part of tile without diagonal */
    dplasma_add2arena_lower( handle->arenas[PARSEC_zungqr_param_LOWER_TILE_ARENA],
                             A->mb*A->nb*sizeof(parsec_complex64_t),
                             PARSEC_ARENA_ALIGNMENT_SSE,
                             parsec_datatype_double_complex_t, A->mb, 0 );

    /* Little T */
    dplasma_add2arena_rectangle( handle->arenas[PARSEC_zungqr_param_LITTLE_T_ARENA],
 ...
 ******************************************************************************/
void
dplasma_zungqr_param_Destruct( parsec_handle_t *handle )
{
    parsec_zungqr_param_handle_t *parsec_zungqr = (parsec_zungqr_param_handle_t *)handle;
