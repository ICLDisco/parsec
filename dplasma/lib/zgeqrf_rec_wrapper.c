                    ...
                    tiled_matrix_desc_t *T )
{
    ...
    object = dague_zgeqrf_rec_new( (dague_ddesc_t*)A,
                               (dague_ddesc_t*)T,
                               ib, NULL, NULL );
    ...
    /* Default type */
    dplasma_add2arena_tile( object->arenas[DAGUE_zgeqrf_rec_DEFAULT_ARENA],
                            A->mb*A->nb*sizeof(dague_complex64_t),
                            DAGUE_ARENA_ALIGNMENT_SSE,
                            MPI_DOUBLE_COMPLEX, A->mb );

    /* Lower triangular part of tile without diagonal */
    dplasma_add2arena_lower( object->arenas[DAGUE_zgeqrf_rec_LOWER_TILE_ARENA],
                             A->mb*A->nb*sizeof(dague_complex64_t),
                             DAGUE_ARENA_ALIGNMENT_SSE,
                             MPI_DOUBLE_COMPLEX, A->mb, 0 );

    /* Upper triangular part of tile with diagonal */
    dplasma_add2arena_upper( object->arenas[DAGUE_zgeqrf_rec_UPPER_TILE_ARENA],
                             A->mb*A->nb*sizeof(dague_complex64_t),
                             DAGUE_ARENA_ALIGNMENT_SSE,
                             MPI_DOUBLE_COMPLEX, A->mb, 1 );

    /* Little T */
    dplasma_add2arena_rectangle( object->arenas[DAGUE_zgeqrf_rec_LITTLE_T_ARENA],
 ...
 ******************************************************************************/
void
dplasma_zgeqrf_rec_Destruct( dague_handle_t *o )
{
    dague_zgeqrf_rec_handle_t *dague_zgeqrf_rec = (dague_zgeqrf_rec_handle_t *)o;

    dplasma_datatype_undefine_type( &(dague_zgeqrf_rec->arenas[DAGUE_zgeqrf_rec_DEFAULT_ARENA   ]->opaque_dtt) );
    dplasma_datatype_undefine_type( &(dague_zgeqrf_rec->arenas[DAGUE_zgeqrf_rec_LOWER_TILE_ARENA]->opaque_dtt) );
    dplasma_datatype_undefine_type( &(dague_zgeqrf_rec->arenas[DAGUE_zgeqrf_rec_UPPER_TILE_ARENA]->opaque_dtt) );
    dplasma_datatype_undefine_type( &(dague_zgeqrf_rec->arenas[DAGUE_zgeqrf_rec_LITTLE_T_ARENA  ]->opaque_dtt) );

    dague_private_memory_fini( dague_zgeqrf_rec->p_work );
    dague_private_memory_fini( dague_zgeqrf_rec->p_tau  );
    free( dague_zgeqrf_rec->p_work );
    free( dague_zgeqrf_rec->p_tau  );

    DAGUE_INTERNAL_HANDLE_DESTRUCT(dague_zgeqrf_rec);
}
...
dplasma_zgeqrf_rec( dague_context_t *dague,
                    ...
                    tiled_matrix_desc_t *T )
{
    dague_handle_t *dague_zgeqrf_rec = NULL;
    ...
    dague_zgeqrf_rec = dplasma_zgeqrf_rec_New(A, T);

    if ( dague_zgeqrf_rec != NULL ) {
        dague_enqueue(dague, (dague_handle_t*)dague_zgeqrf_rec);
