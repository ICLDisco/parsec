 ...
 *
 * dplasma_zgeadd_t_New - Generates an object that computes the operation B =
 * alpha * A' + B
 *
 * See dplasma_map2t_New() for further information.
 *
 ...
 ******************************************************************************/
dague_handle_t*
dplasma_zgeadd_t_New( PLASMA_enum uplo,
 ...
 ******************************************************************************/
void
dplasma_zgeadd_t_Destruct( dague_handle_t *o )
{
 ...
 * alpha * A' + B
 *
 * See dplasma_map2t() for further information.
 *
 *******************************************************************************
 *
 * @param[in,out] dague
 ...
 ******************************************************************************/
int
dplasma_zgeadd_t( dague_context_t *dague,
                PLASMA_enum uplo,
                dague_complex64_t alpha,
                const tiled_matrix_desc_t *A,
                tiled_matrix_desc_t *B)
{
    dague_handle_t *dague_zgeadd_t = NULL;
    ...
    dague_zgeadd_t = dplasma_zgeadd_t_New(uplo, alpha, A, B);

    if ( dague_zgeadd_t != NULL )
    {
        dague_enqueue(dague, (dague_handle_t*)dague_zgeadd_t);
