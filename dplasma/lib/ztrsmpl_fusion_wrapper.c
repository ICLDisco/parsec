                                            ...
                                            tiled_matrix_desc_t *B )
{
    ...
    dague_ztrsmpl_fusion = (dague_handle_t*)dague_ztrsmpl_fusion_new((dague_ddesc_t*)A,
                                                                     (dague_ddesc_t*)IPIV,
                                                                     (dague_ddesc_t*)B,
                                                                     P);

    /* A */
    dplasma_add2arena_tile( ((dague_ztrsmpl_fusion_handle_t*)dague_ztrsmpl_fusion)->arenas[DAGUE_ztrsmpl_fusion_DEFAULT_ARENA],
                            A->mb*A->nb*sizeof(dague_complex64_t),
                            DAGUE_ARENA_ALIGNMENT_SSE,
                            MPI_DOUBLE_COMPLEX, A->mb );

    /* PERMUT */
    dplasma_add2arena_rectangle( ((dague_ztrsmpl_fusion_handle_t*)dague_ztrsmpl_fusion)->arenas[DAGUE_ztrsmpl_fusion_PERMUT_ARENA],
                                 2 * nb * sizeof(int),
                                 DAGUE_ARENA_ALIGNMENT_SSE,
                                 MPI_INT, 2, nb, -1 );
...
void
dplasma_ztrsmpl_fusion_Destruct( dague_handle_t *o )
{
    dague_ztrsmpl_fusion_handle_t *dague_ztrsmpl_fusion = (dague_ztrsmpl_fusion_handle_t *)o;
