...
dplasma_zgetrf_sp_New(double criteria, tiled_matrix_desc_t *A, int *info)
{
    ...
    *info = 0;
    dague_zgetrf_sp = (dague_handle_t*)dague_zgetrf_sp_new(*A, (dague_ddesc_t*)A, criteria, info);

    dplasma_add2arena_tile(((dague_zgetrf_sp_handle_t*)dague_zgetrf_sp)->arenas[DAGUE_zgetrf_sp_DEFAULT_ARENA],
...
void
dplasma_zgetrf_sp_Destruct( dague_handle_t *o )
{
    dague_zgetrf_sp_handle_t *dague_zgetrf_sp = (dague_zgetrf_sp_handle_t *)o;
