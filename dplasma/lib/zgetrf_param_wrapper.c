                                          ...
                                          int* INFO )
{
    ...
    /* IPIV */
    dplasma_add2arena_rectangle( object->arenas[DAGUE_zgetrf_param_PIVOT_ARENA],
                                 A->mb*sizeof(int),
                                 DAGUE_ARENA_ALIGNMENT_SSE,
                                 MPI_INT, A->mb, 1, -1 );
                          ...
                          int* INFO )
{
    ...
    dague_zgetrf_param = dplasma_zgetrf_param_New(qrpiv, A, IPIV, LT, INFO);
...
dplasma_zgetrf_param_Destruct( dague_object_t *o )
{
    ...
    dplasma_datatype_undefine_type( &(dague_zgetrf_param->arenas[DAGUE_zgetrf_param_PIVOT_ARENA     ]->opaque_dtt) );
