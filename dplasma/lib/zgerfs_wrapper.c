...
{
    dague_handle_t *dague_zgerfs = NULL;

    if(mode_exp)
    {
        dague_zgerfs = (dague_handle_t*)dague_zgerfs_exp_new(*A,  (dague_ddesc_t*)A,
                                                             *LU, (dague_ddesc_t*)LU,
                                                             *B,  (dague_ddesc_t*)B,
                                                             *R,  (dague_ddesc_t*)R,
                                                             *X,  (dague_ddesc_t*)X,
        ...
        dplasma_add2arena_tile(((dague_zgerfs_exp_handle_t*)dague_zgerfs)->arenas[DAGUE_zgerfs_exp_DEFAULT_ARENA],
                               A->mb*A->nb*sizeof(dague_complex64_t),
                               DAGUE_ARENA_ALIGNMENT_SSE,
                               MPI_DOUBLE_COMPLEX, A->mb);
    }else{
        dague_zgerfs = (dague_handle_t*)dague_zgerfs_new(*A,  (dague_ddesc_t*)A,
                                                         *LU, (dague_ddesc_t*)LU,
                                                         *B,  (dague_ddesc_t*)B,
                                                         *R,  (dague_ddesc_t*)R,
                                                         *X,  (dague_ddesc_t*)X,
        ...
        dplasma_add2arena_tile(((dague_zgerfs_handle_t*)dague_zgerfs)->arenas[DAGUE_zgerfs_DEFAULT_ARENA],
                               A->mb*A->nb*sizeof(dague_complex64_t),
                               DAGUE_ARENA_ALIGNMENT_SSE,
                               MPI_DOUBLE_COMPLEX, A->mb);
...
void
dplasma_zgerfs_Destruct( dague_handle_t *o )
{
    if(mode_exp)
    {
        dague_zgerfs_exp_handle_t *dague_zgerfs = (dague_zgerfs_exp_handle_t *)o;
        dplasma_datatype_undefine_type( &(dague_zgerfs->arenas[DAGUE_zgerfs_exp_DEFAULT_ARENA]->opaque_dtt) );
    }else{
        dague_zgerfs_handle_t *dague_zgerfs = (dague_zgerfs_handle_t *)o;
                        ...
                        tiled_matrix_desc_t *ddescZ)
{
    ...
    {
        dague_enqueue( dague, (dague_handle_t*)dague_zgerfs);
                    ...
                    tiled_matrix_desc_t *ddescX)
{
    ...
    PASTE_CODE_INIT_AND_ALLOCATE_MATRIX(
        ...
        (&ddescR, matrix_ComplexDouble, matrix_Tile, ddescB->super.nodes, ddescB->super.myrank,
    ...
    PASTE_CODE_INIT_AND_ALLOCATE_MATRIX(
        ...
        (&ddescZ, matrix_ComplexDouble, matrix_Tile, ddescB->super.nodes, ddescB->super.myrank,
         ddescB->mb, ddescB->nb, ddescB->m, ddescB->n, 0, 0, ddescB->m, ddescB->n,
         ((two_dim_block_cyclic_t*)ddescB)->grid.strows,
         ((two_dim_block_cyclic_t*)ddescB)->grid.stcols,
         ((two_dim_block_cyclic_t*)ddescB)->grid.rows));
