 ...
 *
 * dplasma_zgetrf_qrf_New - Generates the taskpool that computes an hybrid LU-QR
 ...
 * @ingroup dplasma_complex64
 *
 *  dplasma_zgetrf_qrf_Destruct - Free the data structure associated to an taskpool
