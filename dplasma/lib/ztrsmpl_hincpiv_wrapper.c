...
dague_object_t* dplasma_ztrsmpl_hincpiv_New( qr_piv_t *qrpiv,
                                          ...
                                          int* INFO )
{
     ...
     */
    object = dague_ztrsmpl_hincpiv_new( *A,  (dague_ddesc_t*)A,
					                  *B,  (dague_ddesc_t*)B,
                                          (dague_ddesc_t*)IPIV,
                                     *LT, (dague_ddesc_t*)LT,
                                     qrpiv, ib,
                          ...
                          int* INFO )
{
    ...
    dague_ztrsmpl_hincpiv = dplasma_ztrsmpl_hincpiv_New(qrpiv, A, B, IPIV, LT, INFO);
