 ...
 * Local function
 */
static int pins_papi_exec_component_query(mca_base_module_t **module, int *priority);

/*
 * Instantiate the public struct with all of our public information
 * and pointers to our public functions in it
 */
const dague_pins_base_component_t dague_pins_papi_exec_component = {
...

    {
        ...
        NULL,
        NULL,
        pins_papi_exec_component_query,
...
{
    return (mca_base_component_t *)&dague_pins_papi_exec_component;
}

static int pins_papi_exec_component_query(mca_base_module_t **module, int *priority)
{
    /* module type should be: const mca_base_module_t ** */
    void *ptr = (void*)&dague_pins_papi_exec_module;
    *priority = 4;
