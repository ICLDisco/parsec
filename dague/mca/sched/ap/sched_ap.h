 ...
 */
DAGUE_DECLSPEC extern const dague_sched_base_component_t dague_sched_ap_component;
DAGUE_DECLSPEC extern const dague_sched_module_t dague_sched_ap_module;
/* static accessor */
