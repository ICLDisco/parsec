...
int main(int argc, char ** argv)
{
...
#if defined(PARSEC_HAVE_MPI)
    {
        ...
        if(MPI_THREAD_MULTIPLE > provided) {
            parsec_fatal( "This test requires MPI_THREAD_MULTIPLE because it uses simultaneously MPI within the PaRSEC runtime, and in the main program loop (in SYNC_TIME_START)");
        }
    }
