...
if(PARSEC_PROF_TRACE AND Python_FOUND)
  ...
  parsec_addtest_cmd(generate_async_profile ${SHM_TEST_CMD_LIST} ./async 1000 -- --mca profile_filename async  --mca mca_pins task_profiler)

  parsec_addtest_cmd(generate_hdf5_file ${SHM_TEST_CMD_LIST}
                     ${Python_EXECUTABLE}
  ...
  parsec_addtest_cmd(check_hdf5_file ${SHM_TEST_CMD_LIST} ${Python_EXECUTABLE} ${CMAKE_CURRENT_SOURCE_DIR}/check-profile.py async.h5)
  set_property(TEST check_hdf5_file APPEND PROPERTY DEPENDS generate_hdf5_file)

  parsec_addtest_cmd(cleanup_profile_files ${SHM_TEST_CMD_LIST} rm -f async-0.prof async.h5)
