...
parsec_addtest_cmd(reshape_remote_multiple_outs_same_pred_flow_shm ${SHM_TEST_CMD_LIST} ./remote_multiple_outs_same_pred_flow -N 320 -t 9 -c 10)
parsec_addtest_cmd(reshape_remote_multiple_outs_same_pred_flow_shm_multi ${SHM_TEST_CMD_LIST} ./remote_multiple_outs_same_pred_flow -N 320 -t 9 -c 10 -m 1)
if( MPI_C_FOUND )
  parsec_addtest_cmd(reshape_remote_multiple_outs_same_pred_flow_mpi ${MPI_TEST_CMD_LIST} 4 ./remote_multiple_outs_same_pred_flow -N 320 -t 9 -c 10 )
  parsec_addtest_cmd(reshape_remote_multiple_outs_same_pred_flow_mpi_multi ${MPI_TEST_CMD_LIST} 4 ./remote_multiple_outs_same_pred_flow -N 320 -t 9 -c 10 -m 1 )
endif( MPI_C_FOUND)
