...
int parsec_profiling_ts_trace(int key, uint64_t event_id, uint32_t object_id,
                             void *info );
int parsec_profiling_ts_trace_flags(int key,
...
/**
 * Returns a char * (owned by parsec_profiling library)
 ...
 *  (appropriately) in parsec_profiling_add_dictionary_keyword
 */
