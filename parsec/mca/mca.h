 ...
 * Historical notes:
 *
 * parsec Modular Component Architecture comes from Open MPI's MCA.
 * Open MPI MCA historical notes follow.
 *
...
#define MCA_BASE_METADATA_PARAM_DEBUG       (uint32_t)0x02 /**< Debug enabled/only Component */
...
enum {
  ...
  MCA_ERR_NOT_AVAILABLE = -12,
  /**< Returned by functionality that is not available. */
