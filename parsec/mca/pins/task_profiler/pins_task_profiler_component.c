 ...
 */
const parsec_pins_base_component_t parsec_pins_task_profiler_component = {
...
{
    return (mca_base_component_t *)&parsec_pins_task_profiler_component;
}

static int pins_task_profiler_component_query(mca_base_module_t **module, int *priority)
{
    /* module type should be: const mca_base_module_t ** */
    void *ptr = (void*)&parsec_pins_task_profiler_module;
    *priority = 50;
