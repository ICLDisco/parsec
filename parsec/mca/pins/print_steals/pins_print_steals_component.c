 ...
 */
const parsec_pins_base_component_t parsec_pins_print_steals_component = {
...
{
    return (mca_base_component_t *)&parsec_pins_print_steals_component;
}

static int pins_print_steals_component_query(mca_base_module_t **module, int *priority)
{
    /* module type should be: const mca_base_module_t ** */
    void *ptr = (void*)&parsec_pins_print_steals_module;
    *priority = 6;
