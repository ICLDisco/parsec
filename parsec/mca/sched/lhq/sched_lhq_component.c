 ...
 */
const parsec_sched_base_component_t parsec_sched_lhq_component = {
...

    {
        ...
        sched_lhq_component_register, /*< Register at least the SDE events */
        "", /*< no reserve */
    },
    {
...
{
    return (mca_base_component_t *)&parsec_sched_lhq_component;
}

static int sched_lhq_component_query(mca_base_module_t **module, int *priority)
{
    /* module type should be: const mca_base_module_t ** */
    void *ptr = (void*)&parsec_sched_lhq_module;
    *priority = 15;
...
static int sched_lhq_component_register(void)
{
    parsec_sched_lhq_module.module.register_sde(NULL);
    return MCA_SUCCESS;
}
