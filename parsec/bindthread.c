...
int parsec_bindthread(int cpu, int ht)
{
...
#elif defined(PARSEC_HAVE_HWLOC) && !defined(__APPLE__)
    {
...
#elif defined(__APPLE__)
    {
        ...
        ap.affinity_tag = cpu; /* non-null affinity tag, ignore ht as OSX cannot bind to specific ht */
...
{
#if defined(__APPLE__)
    return -1; /* not supported on this architecture */
#endif
