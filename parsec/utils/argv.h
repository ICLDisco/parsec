 ...
 */
PARSEC_DECLSPEC  int parsec_argv_append(int *argc, char ***argv, const char *arg);
 ...
 * @retval OPAL_ERROR On failure
 *
 * This function is identical to the parsec_argv_append() function
 ...
 */
PARSEC_DECLSPEC  int parsec_argv_append_nosize(char ***argv, const char *arg);
 ...
 * @retval OPAL_ERROR On failure
 */
PARSEC_DECLSPEC int parsec_argv_prepend_nosize(char ***argv, const char *arg);
 ...
 * @retval OPAL_ERROR On failure
 *
 * This function is identical to the parsec_argv_append_nosize() function
 ...
 */
PARSEC_DECLSPEC  int parsec_argv_append_unique_nosize(char ***argv, const char *arg, bool overwrite);
 ...
 * array.
 */
PARSEC_DECLSPEC  void parsec_argv_free(char **argv);
 ...
 * without invalidating the output argv).
 */
PARSEC_DECLSPEC  char **parsec_argv_split_with_empty(const char *src_string, int delimiter);
 ...
 */
PARSEC_DECLSPEC  int parsec_argv_count(char **argv);
 ...
 */
PARSEC_DECLSPEC  char *parsec_argv_join(char **argv, int delimiter);

PARSEC_DECLSPEC  char *parsec_argv_join_range(char **argv, size_t start, size_t end, int delimiter);
 ...
 */
PARSEC_DECLSPEC  size_t parsec_argv_len(char **argv);
 ...
 */
PARSEC_DECLSPEC  char **parsec_argv_copy(char **argv);
 ...
 * Similar to parsec_argv_append(), the target may be realloc()'ed
 ...
 * target).
 */
PARSEC_DECLSPEC  int parsec_argv_insert(char ***target, int start, char **source);
 ...
 * target).
 */
PARSEC_DECLSPEC  int parsec_argv_insert_element(char ***target, int location, char *source);
