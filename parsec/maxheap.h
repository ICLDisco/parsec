 ...
 */
static inline parsec_heap_t* heap_create(void)
{
...
static inline void heap_destroy(parsec_heap_t** heap)
{
...
static int get_size(parsec_execution_context_t * node); // for debug use only (recursive)
