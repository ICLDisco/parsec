...
enum {
    PARSEC_SUCCESS                 = (PARSEC_ERR_BASE -  1),  /* keep going, we're doing good; must be the highest 'error' value */
    PARSEC_ERROR                   = (PARSEC_ERR_BASE -  2),  /* oops, can't recover; must be the second highest error value */
    ...
    PARSEC_ERR_EXISTS              = (PARSEC_ERR_BASE -  6),  /* file/object exists */
    PARSEC_ERR_NOT_IMPLEMENTED     = (PARSEC_ERR_BASE -  7),  /* functionality not yet supported */
    PARSEC_ERR_NOT_SUPPORTED       = (PARSEC_ERR_BASE -  8),  /* concept not supported */
    PARSEC_ERR_VALUE_OUT_OF_BOUNDS = (PARSEC_ERR_BASE -  9),
    PARSEC_ERR_TRUNCATE            = (PARSEC_ERR_BASE - 10),  /* data read/received is truncated */
    PARSEC_ERR_DEVICE              = (PARSEC_ERR_BASE - 11),  /* an error rendered the device unusable */
};
