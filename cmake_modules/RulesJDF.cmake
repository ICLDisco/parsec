...
# Each jdf file can also be tagged with specific flags for the parsecpp
# binary through the ADDITIONAL_PARSECPP_CFLAGS property.
#
  ...
  foreach(jdf_rules_SOURCE ${jdf_rules_SOURCES})
    ...
    if( jdf_rules_IsInBinaryDir )
      ...
      add_custom_command(
        ...
        COMMAND ${parsecpp_EXE} ${PARSECPP_CFLAGS} ${ADDITIONAL_PARSECPP_CFLAGS} -E -i ${jdf_rules_SRC}.jdf -o ${jdf_rules_OSRC} -f ${jdf_rules_BSRC}
        MAIN_DEPENDENCY ${CMAKE_CURRENT_BINARY_DIR}/${jdf_rules_SRC}.jdf
        DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${jdf_rules_SRC}.jdf ${parsecpp_EXE})
      ...
      add_custom_command(
        ...
        DEPENDS ${jdf_rules_SRC}.jdf ${parsecpp_EXE})
