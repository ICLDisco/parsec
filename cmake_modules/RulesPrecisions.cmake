    ...
    foreach(prec_rules_PREC ${PREC_RULE_PRECISIONS})
      ...
      elseif("${prec_rules_PREC}" MATCHES "\\+")
        ...
        elseif(${precisions_rules_PP})
          execute_process(COMMAND ${PRECISIONPP} --file ${CMAKE_CURRENT_SOURCE_DIR}/${prec_rules_SOURCE} --prec ${prec_rules_PREC} --prefix ${PREC_RULE_TARGETDIR} --out
          ...
          if( ${got_file} )
            add_custom_command(
              OUTPUT ${prec_rules_OSRC}
              COMMAND ${PRECISIONPP} --file ${CMAKE_CURRENT_SOURCE_DIR}/${prec_rules_SOURCE} --prec ${prec_rules_PREC} --prefix ${PREC_RULE_TARGETDIR}
              MAIN_DEPENDENCY ${CMAKE_CURRENT_SOURCE_DIR}/${prec_rules_SOURCE}
              DEPENDS ${PRECISIONPP})
          endif()
        else()
