...
macro(precisions_rules)
    ...
    foreach(prec_rules_PREC ${PREC_RULE_PRECISIONS})
      ...
      elseif("${prec_rules_PREC}" MATCHES "\\+")
        ...
        elseif(${precisions_rules_PP})
          ...
          string(COMPARE EQUAL "${prec_rules_OSRC}" "${prec_rules_SOURCE}" src_file)
          # We generate a dependency only if a file will be generated
          if( got_file AND NOT src_file )
  ...
  # message(STATUS ${OUTPUTLIST})
  # message(STATUS ${prec_rules_OSRC})
  # foreach(fileo IN LISTS ${OUTPUTLIST})
  #   message(${fileo})
  # endforeach()
  # message(STATUS "-----------")
