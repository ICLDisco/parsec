    ...
    if( PLASMA_cblas_LIB AND PLASMA_coreblas_LIB AND PLASMA_corelapack_LIB AND PLASMA_plasma_LIB )
      ...
      set( FOUND_PLASMA_LIB 1)
        ...
        if( PLASMA_quark_LIB AND PLASMA_coreblas_LIB AND PLASMA_plasma_LIB )
            if( PLASMA_cblas_LIB )
                set( PLASMA_LIBRARIES "${PLASMA_coreblas_LIB};${PLASMA_plasma_LIB};${PLASMA_quark_LIB};${PLASMA_lapack_cwrapper_LIB};${LAPACK_LIBRARIES};${PLASMA_cblas_LIB}")
            else(PLASMA_cblas_LIB)
                set( PLASMA_LIBRARIES "${PLASMA_coreblas_LIB};${PLASMA_plasma_LIB};${PLASMA_quark_LIB};${PLASMA_lapack_cwrapper_LIB};${LAPACK_LIBRARIES}")
