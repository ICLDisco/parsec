...
if(LEVEL_ZERO_ROOT_DIR)
    ...
    if(ZE_LOADER_LIBRARY AND LEVEL_ZERO_INCLUDE_DIR)
	    ...
	    if(NOT LEVEL_ZERO_INCLUDE_DIR)
		    message(WARNING "Could not find level_zero/ze_api.h under provided LEVEL_ZERO_ROOT_DIR=${LEVEL_ZERO_ROOT_DIR}' (tried subdirectory include) -- falling back to package config search")
