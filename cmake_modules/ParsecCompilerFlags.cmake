...
if( C_M32or64 )
  ...
  set(arch_build "$<$<COMPILE_LANGUAGE:C>:${arch_build}>")
  if( F_M32or64 )
    list(APPEND arch_build "$<$<COMPILE_LANGUAGE:Fortran>:${arch_build}>")
  endif( F_M32or64 )
  if( CXX_M32or64 )
    list(APPEND arch_build "$<$<COMPILE_LANGUAGE:CXX>:${arch_build}>")
  endif( CXX_M32or64 )
  set(PARSEC_ARCH_OPTIONS "$<$<COMPILE_LANGUAGE:C>:${arch_build}>" CACHE STRING "List of compile options used to select the target architecture (e.g., -m64, -mtune=haswell, etc.)")
