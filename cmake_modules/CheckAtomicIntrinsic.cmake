...
unset(_PARSEC_ATOMIC_SUPPORT_CFLAGS)
  ...
  if( PARSEC_HAVE_INT128 AND PARSEC_ATOMIC_USE_C11_32 AND PARSEC_ATOMIC_USE_C11_64 )
    ...
    if( NOT PARSEC_ATOMIC_USE_C11_128 ) # try again with -mcx16
      ...
      if( PARSEC_ATOMIC_USE_C11_128 )
        ...
        LIST(APPEND _PARSEC_ATOMIC_SUPPORT_CFLAGS "-mcx16")
...
set(PARSEC_ATOMIC_SUPPORT_CFLAGS ${_PARSEC_ATOMIC_SUPPORT_CFLAGS} CACHE STRING "Flags needed for atomic support")
MARK_AS_ADVANCED(PARSEC_ATOMIC_SUPPORT_CFLAGS)
